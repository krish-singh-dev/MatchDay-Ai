...
exports.STADIUM_ASSISTANT_SYSTEM_INSTRUCTION = void 0;
...
exports.STADIUM_ASSISTANT_SYSTEM_INSTRUCTION = `
...
async function askGemini(query) {
    ...
    try {
        const response = await aiClient.models.generateContent({
            ...
            contents: query,
            config: {
                systemInstruction: exports.STADIUM_ASSISTANT_SYSTEM_INSTRUCTION,
                temperature: 0.2,
            },
        });
